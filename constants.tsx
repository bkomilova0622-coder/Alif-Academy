...
export const ARABIC_ALPHABET: ColoredArabicLetter[] = [
  ...
  { char: 'ب', name: 'Ba', transliteration: 'b', exampleWord: 'بطة', exampleTranslation: 'Duck', exampleImage: 'https://images.unsplash.com/photo-1555854816-6aa6131f28bc?auto=format&fit=crop&q=80&w=200&h=200', color: 'bg-pink-100', darkColor: 'text-pink-600' },
  ...
  { char: 'ث', name: 'Tha', transliteration: 'th', exampleWord: 'ثعلب', exampleTranslation: 'Fox', exampleImage: 'https://images.unsplash.com/photo-1516934024742-b461fbc4760a?auto=format&fit=crop&q=80&w=200&h=200', color: 'bg-amber-100', darkColor: 'text-amber-600' },
  ...
  { char: 'ر', name: 'Ra', transliteration: 'r', exampleWord: 'رمان', exampleTranslation: 'Pomegranate', exampleImage: 'https://images.unsplash.com/photo-1541334922629-5e587b990ffb?auto=format&fit=crop&q=80&w=200&h=200', color: 'bg-violet-100', darkColor: 'text-violet-600' },
  { char: 'ز', name: 'Zay', transliteration: 'z', exampleWord: 'زرافة', exampleTranslation: 'Giraffe', exampleImage: 'https://images.unsplash.com/photo-1547721064-362021817572?auto=format&fit=crop&q=80&w=200&h=200', color: 'bg-purple-100', darkColor: 'text-purple-600' },
  { char: 'س', name: 'Seen', transliteration: 's', exampleWord: 'سمكة', exampleTranslation: 'Fish', exampleImage: 'https://images.unsplash.com/photo-1524704659690-3f7a37d9ee23?auto=format&fit=crop&q=80&w=200&h=200', color: 'bg-fuchsia-100', darkColor: 'text-fuchsia-600' },
  ...
  { char: 'ط', name: 'Ta', transliteration: 't', exampleWord: 'طائرة', exampleTranslation: 'Plane', exampleImage: 'https://images.unsplash.com/photo-1436491865332-7a61a109c7d3?auto=format&fit=crop&q=80&w=200&h=200', color: 'bg-orange-100', darkColor: 'text-orange-600' },
  ...
  { char: 'ع', name: 'Ain', transliteration: 'a', exampleWord: 'عصفور', exampleTranslation: 'Bird', exampleImage: 'https://images.unsplash.com/photo-1444464666168-49d633b867ad?auto=format&fit=crop&q=80&w=200&h=200', color: 'bg-blue-100', darkColor: 'text-blue-600' },
  ...
  { char: 'م', name: 'Meem', transliteration: 'm', exampleWord: 'موز', exampleTranslation: 'Banana', exampleImage: 'https://images.unsplash.com/photo-1571771894821-ad9b58866602?auto=format&fit=crop&q=80&w=200&h=200', color: 'bg-orange-100', darkColor: 'text-orange-600' },
  ...
  { char: 'هـ', name: 'Ha', transliteration: 'h', exampleWord: 'هلال', exampleTranslation: 'Crescent', exampleImage: 'https://images.unsplash.com/photo-1496030514104-5f114620023a?auto=format&fit=crop&q=80&w=200&h=200', color: 'bg-blue-100', darkColor: 'text-blue-600' },
  ...
  { char: 'ي', name: 'Ya', transliteration: 'y', exampleWord: 'يد', exampleTranslation: 'Hand', exampleImage: 'https://images.unsplash.com/photo-1516733968668-dbdce39c46ef?auto=format&fit=crop&q=80&w=200&h=200', color: 'bg-cyan-100', darkColor: 'text-cyan-600' },
];
